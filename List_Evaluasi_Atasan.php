...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <title>LIST EVALUASI ATASAN PEGAWAI</title>
  <meta charset="utf-8">
...
<br>
<div class="row">
  <div class="col-md-6 col-md-offset-2"><b style="font-size:20px">LIST EVALUASI ATASAN PEGAWAI</b></div>
</div>
<br>
...
print '<table style="width:100%">
  ...
  for($i=1;$i<=23;$i=$i+4)
  {
	...
	<tr>
    <td>Bulan ke- '.$j.'</td>		
    <td><a href="Form_PLT53.php?session='.$session.'&bulan='.$i.'&user='.$user.'">Detail</a></td>
    </tr>';$j++;
  }
echo '</table>';
print '</div></div>';
