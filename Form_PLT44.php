...
<br>
<?php
echo '<form class="form-horizontal" method="post" action="insert_realisasi.php?session='.$session.'">';
?>
...
if ($result->num_rows > 0) {
    ...
    echo '<div class="col-sm-5">';
	echo '<input type="text" class="form-control" placeholder="" name="realisasi_kuantitas'.$y.$i.'">';
	echo '</div>';
	echo '</div>';
    ...
    echo '<div class="col-sm-5">';
	echo '<input type="text" class="form-control" placeholder="" name="realisasi_kualitas'.$y.$i.'">';
	echo '</div>';
	echo '</div>';
    ...
    echo '<div class="col-sm-5">';
	echo '<input type="text" class="form-control" placeholder="" name="realisasi_waktu'.$y.$i.'">';
	echo '</div>';
	echo '</div>';
...
<?php echo '<a href="List_Laporan_Mingguan.php?session='.$session.'&user2='.$user.'" class="btn btn-success btn-lg active spacer2 btn-sm" role="button">List Formulir</a>';?>
</div>
