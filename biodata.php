...
<table width=98% border=0 cellspacing=0 cellpadding=0 align=center>
  <tr>
    ...
    <td colspan=3 align=center><font size=4 color = white><b>.: BIODATA :.</b></font></td>
	 <td ><strong> <font size=2 ><a href='cetak.php?session=$session&nipeg=$user&pos=$kd_posisi' target='_blank' ><img src=images/print_icon.png></a></font></strong></td>
...
<table width=98% border=2 cellspacing=0 cellpadding=2 align=center>
  ...
  <tr>
    ...
    <td align=left><span class="style9 style2">Hingga</span></td>
	 <td align=left><span class="style9 style2">dosir</span></td>
  </tr>
  <?
/* riwayat jabatan */
$urut = 1;
$sql1 = "select jabatan, kd_unit, unit_kerja, barea, parea ,tgl_jabat, tgl_akhir,grade_sk,tgl_sk
         from $tbl_bio03 where nipeg='$nipeg' order by tgl_jabat ASC";
$q1 = mysql_query($sql1);
while(list($jabatan, $kd_unit, $unit_kerja, $barea, $parea, $tgl_jabat, $tgl_akhir, $grade_sk, $no_sk, $tgl_sk) = mysql_fetch_row($q1)) {
  /* rapihkan tampilan */
...
*/
  ...
  <tr bgcolor= white>
    ...
    <td align=left>$tgl_jabat</td>
	 ...
	 ";
$sqldosir = "select Keterangan, No_SK, Tgl_SK
         from $tbl_dozir where nipeg='$nipeg' && id_dozir ='04'  && Tgl_SK ='tgl_sk'";
$q1 = mysql_query($sqldosir);
$namafileku = mysql_fetch_row($q1) ;
