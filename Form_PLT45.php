...
$sql2 = "SELECT nipeg FROM laporan_pelaksanaan WHERE nipeg = '$user'";
$result = mysqli_query($conn, $sql2);

if ($result->num_rows > 0) {
	header("Location: Form_PLT453.php?session=$session&user2=$user");
...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		...
		if($jumlah == $posisi)
	{
			header("Location: Form_PLT452.php?session=$session&user2=$pengisi");
	}
	else{}
	}
} else {
...
<!--div class="form-group">
 ...
 <div class="form-group">
    <div class="col-sm-5" >
<textarea type="text" class="form-control" placeholder="" name="judul"></textarea>
</div>
</div>
...
<br>
 ...
 <div class="form-group">
    <div class="col-sm-5">
<textarea type="text" class="form-control" placeholder="" name="abstrak"></textarea>
</div>
</div>
<br>
 ...
 <div class="form-group">
    <div class="col-sm-5">
<textarea type="text" class="form-control" placeholder="" name="latarbelakang"></textarea>
</div>
</div>
<br>
 ...
 <div class="form-group">
    <div class="col-sm-5">
<textarea type="text" class="form-control" placeholder="" name="laporanpencapaian"></textarea>
</div>
</div>
<br>
 ...
 <div class="form-group">
    <div class="col-sm-5">
<textarea type="text" class="form-control" placeholder="" name="usulanrekomendasi"></textarea>
</div>
</div>
<br>
