...
$sql = "SELECT feedback FROM feedback_realisasi where nipeg = '$user2' AND pekan = '$pekan'";
$result = $conn->query($sql);
...
$status = null;  
$sql = "SELECT status FROM feedback_realisasi where nipeg = '$user2' AND pekan = '$pekan'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
	...
	{
		echo '<div id="tombol">';
		echo '<button type="submit" class="btn btn-warning" name="tombol4" value="1" disabled="disabled">Belum Disetujui</button>';
		echo '</div>';
	}
	else{
		echo '<div id="tombol">';
		echo '<button type="submit" class="btn btn-success" name="tombol4" value="0" disabled="disabled">Disetujui</button>';
		echo '</div>';
	}
