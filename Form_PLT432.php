...
<br>
<?php
echo '<form class="form-horizontal" method="post" action="insert_feedback.php?session='.$session.'&user2='.$user2.'&hari='.$hari.'">';
?>
<?php
...
echo '<div class="col-sm-5">';
	...
	echo '<textarea class="form-control" rows="3" name="feedback_harian"></textarea>';
	echo '</div>';
  echo '</div>';
...
if ($result->num_rows > 0) {
	...
	{
		echo '<div id="tombol">';
		echo '<button type="submit" class="btn btn-warning" name="tombol3" value="1" >Setujui</button>';
		echo '</div>';
		
		echo '<div id="tombol">';
		echo '<button type="submit" class="btn btn-success" name="tombol3" value="0" >Batal Setujui</button>';
		echo '</div>';
	}
	else{
		echo '<div id="tombol">';
